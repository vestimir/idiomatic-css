...
Този документ описва наръчник за стил на писане, при разработката на CSS код.
Тези насоки насърчават използването на вече съществуващи, общи, логични модели.
...
* Не се опитвайте да оптимизирате прекалено своя код от самото начало; старайте се да е четим и разбираем.
